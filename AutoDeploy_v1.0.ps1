...
NEW:
1. Added a separate function named CheckForReboot.
2. Added a function that would automatically launch KeyDeploy.
...
Write-Output "STEP 5: DEPLOYMENT $newline"
LocalAccountRemoval
#DeployKey
#CheckWindowsLicense

Write-Output "FINAL STEP: Sysprep"
CheckSysprep
#OOBE
